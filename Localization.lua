...
L["Announce when quest be accepted"] = "Kündigen Sie an, wann die Quest angenommen wird"
...
L["Announce when quest be accepted"] = "퀘스트를 수락하면 알림"
...
if L then
L["Announce Every"] = "详细通报"
L["Announce progression every x number of steps (0 will announce on quest objective completion only)"] = "详细通报进度每一项的每一步"
...
L["Announce when quest be accepted"] = "接受新任務時通報"
